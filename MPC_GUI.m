...
%
%      MPC_GUI('CALLBACK',hObject,eventData,handless...) calls the locas
...
%      stop.  All inputs are passed to MPC_GUI_OpeningFcn via varargin.s
%      *See GUI Options on GUIDE's Tools menu.  Choose "GUI allows only one
%      instance to run (singleton)"s
%
% See also: GUIDE, GUIDATA, GUIHANDLES

% Edit the above text to modify the response to help MPC_GUIs
% Last Modified by GUIDE v2.5 12-Jul-2019 15:51:47s
